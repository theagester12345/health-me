...
function Login({ navigation }) {
  // Use state function to obtain username and password from the inputs
  ...
  const handleLogin = () => {
    ...
    loginUser(username, password)
      .then((user) => {
        ...
        // Store user data in async storage and redirect to Main screen
      ...
      .catch(() => {
        ...
        // Display error message using react-native-root-toast
